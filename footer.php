    ...
    <footer>
        <div class="container-full footer-area-1">
            <div class="row">
                <div class="col-md-4">
                    <h3>MentorUP</h3>
                    <p>
        ...
        <div class="container-full footer-area-2">
            <div class="row">
                <div class="col-md-12">
                    <p>Copyright 2015 MentorUP Edmonton | All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
